...
function objectDelete(authInfo, request, log, cb) {
    ...
    console.log('decodedVidResult!!!', decodedVidResult);
    ...
    return async.waterfall([
        function validateBucketAndObj(next) {
            ...
            (err, bucketMD, objMD) => {
                ...
                console.log('reqVersionId!!!', reqVersionId);
                console.log('objMD!!!', objMD);
                if (reqVersionId && objMD.location && objMD.location[0] &&
                objMD.location[0].dataStoreType === 'azure') {
                    return next(errors.NotImplemented, bucketMD);
                }
