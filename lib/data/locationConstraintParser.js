...
//            const gcpParams = {
//                endpoint: locationObj.details.gcpEndpoint,
//                projectId: locationObj.details.projectId,
//                keyFilename: locationObj.details.keyFilename,
//            };
//            clients[location] = new GcpClient({
//                gcpParams,
//                gcpBucketName: locationObj.details.gcpBucketName,
//                bucketMatch: locationObj.details.bucketMatch,
//            });
//            clients[location].clientType = 'gcp';
//        }
    });
    return clients;
}
